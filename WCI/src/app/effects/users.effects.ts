...
//import authenticate actions
import { AuthenticateAction}  from '../actions/users.actions'
...
export class UserEffects {
  ...
  public authenticate: Observable<Action> = this.actions
    ...
    .switchMap(payload => {
      return this.userService.authenticate(payload.username, payload.password, payload.site)

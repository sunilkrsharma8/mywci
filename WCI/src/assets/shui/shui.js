...
RegisterHtmlTemplate.register("<dom-module id=sh-tabs> <template> <style include=shared-styles>:host{width:fit-content;height:fit-content;display:flex;flex-direction:row;overflow:hidden;outline:0;}</style> <slot></slot> </template> </dom-module>");
